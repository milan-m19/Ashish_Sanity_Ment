...
public class HomePage {
	...
	@FindBy(how = How.XPATH, using = "//span[text()='CISCE']")
	private WebElement textCISCEBoard;
	
	@FindBy(how = How.XPATH, using = "//span[@class='mr-24']//span[text()='English']")
	private WebElement textEnglishMedium;
	
	@FindBy(how = How.XPATH, using = "//span[@class='mr-24']//span[text()='Class 2']")
	private WebElement TextClasss2;
	...
	public WebElement getTextCISCEBoard() {
		return textCISCEBoard;
	}


	public WebElement getTextEnglishMedium() {
		return textEnglishMedium;
	}


	public WebElement getTextClasss2() {
		return TextClasss2;
	}
