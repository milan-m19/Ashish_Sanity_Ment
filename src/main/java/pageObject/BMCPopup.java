...
public class BMCPopup {
	...
	@FindBy(how=How.XPATH,using="//mat-option[@id='mat-option-25']")
	private WebElement CISCE;
	...
	@FindBy(how=How.XPATH,using="(//span[text()='English'])[5]")
	private WebElement ENglish;
	
	@FindBy(how=How.XPATH,using="//span[text()='Hindi']")
	private WebElement HIndi;
	
	@FindBy(how=How.XPATH,using="//span[text()='English']//parent::*[@aria-label='English']")
	private WebElement selectMediumValue;
	
	@FindBy(how=How.XPATH,using="(//span[text()='CBSE'])[3]")
	private WebElement selectBoardValue;
	
	@FindBy(how=How.XPATH,using="(//*[contains(@aria-label,'Class 1')]//following::span[2])[1]")
	private WebElement selectClassValue;
	
	@FindBy(how=How.XPATH,using="(//span[text()='CISCE'])[2]")
	private WebElement BoardCE;
	
	public WebElement getBoardCE() {
		return BoardCE;
	}
	
	public WebElement getselectClassValue() {
		return selectClassValue;
	}
	
	
	public WebElement getselectBoardValue() {
		return selectBoardValue;
	}
	
	public WebElement getselectMediumValue() {
		return selectMediumValue;
	}
	...
	@FindBy(how = How.XPATH, using = "//mat-option[@id='mat-option-25']")
	private WebElement BoardC;

	public WebElement getBoardC() {
		return BoardC;
	}
